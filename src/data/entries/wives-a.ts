...
export const murasaki: Character = {
  ...
  relations: [
    ...
    { targetId: 'fujitsubo', type: 'blood', label: '姑母' },
...
export const aoi: Character = {
  ...
  relations: [
    ...
    { targetId: 'tou-no-chujo', type: 'blood', label: '兄妹' },
    { targetId: 'yugiri', type: 'blood', label: '母子' },
...
export const yugao: Character = {
  ...
  story: [
    ...
    {
      chapter: '夕颜',
      text: '死后源氏悲恸成疾，从此留下终身阴影；他后来在玉鬘身上不断寻找她的影子。',
    },
    {
      chapter: '行幸',
  ...
  relations: [
    ...
    { targetId: 'tamakazura', type: 'blood', label: '母女' },
...
export const akashi: Character = {
  ...
  quotes: [
    {
      jp: '明石の君の心は悲しみに満たされていた。',
      zh: '明石君的心中充满悲伤。（与谢野晶子现代日语译文）',
      chapter: '明石帖',
    },
  ],
  evaluations: [
  ...
  relations: [
    { targetId: 'genji', type: 'marriage', label: '侧室' },
