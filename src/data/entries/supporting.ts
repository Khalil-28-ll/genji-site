...
export const reizei: Character = {
  ...
  life: {
    birth: '红叶贺帖（源氏 19 岁）',
    death: '书中未明示（竹河帖后少出场）',
    note: '即位在澪标帖（源氏约 26–27 岁）；让位今上帝在若菜下帖（源氏约 40–41 岁）。',
  },
  story: [
    {
      chapter: '红叶贺',
...
export const ochiba: Character = {
  ...
  life: {
    birth: '书中未明示',
    death: '书中未明示（夕雾帖后少出场）',
    note: '嫁柏木在若菜下帖之前；被夕雾强娶在夕雾帖（源氏约 44–45 岁）。',
  },
  story: [
    {
      chapter: '柏木',
...
export const akashiChugu: Character = {
  ...
  life: {
    birth: '澪标帖前后（源氏约 26–27 岁，生于明石）',
    death: '书中未明示',
    note: '入内为今上帝中宫在藤裏叶帖（源氏约 33–34 岁）；生匂宫在若菜上帖（源氏约 39–40 岁）。',
  },
  story: [
    {
      chapter: '明石',
...
export const akikonomu: Character = {
  ...
  life: {
    birth: '书中未明示（朱雀帝朝）',
    death: '书中未明示',
    note: '入内为梅壶女御在绘合帖（源氏约 27–28 岁）；立为冷泉帝中宫在少女帖（源氏约 30 岁）。',
  },
  story: [
    {
      chapter: '贤木',
