...
export const niou: Character = {
  ...
  story: [
    ...
    {
      chapter: '椎本',
      age: '薰 23—24 岁（匂宫 24—25 岁）',
      text: '听闻宇治八宫之女的名声，与中君通信求爱。',
    },
    {
      chapter: '总角',
      age: '薰 24 秋—冬（匂宫 25 岁）',
...
export const ukifune: Character = {
  ...
  life: {
    ...
    note: '投川在浮舟帖（薰 27 春）；出家在手习帖（薰 27—28 夏）。',
  },
  story: [
    {
      chapter: '宿木',
