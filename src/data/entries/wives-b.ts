...
export const onnaSannomiya: Character = {
  ...
  relations: [
    ...
    { targetId: 'suzaku', type: 'blood', label: '父女' },
    { targetId: 'kashiwagi', type: 'love', label: '私通（薰之生父）' },
    { targetId: 'kaoru', type: 'blood', label: '母子（实为柏木之子）' },
  ],
};
...
export const utsusemi: Character = {
  ...
  relations: [
    { targetId: 'genji', type: 'love', label: '拒爱·不即不离' },
  ],
};
...
export const suetsumuhana: Character = {
  ...
  chapters: ['末摘花', '蓬生', '初音'],
  relations: [
    { targetId: 'genji', type: 'marriage', label: '侧室（同情性照顾）' },
  ],
};
...
export const oborozukiyo: Character = {
  ...
  chapters: ['花宴', '贤木', '若菜'],
  relations: [
    { targetId: 'genji', type: 'love', label: '情人（禁忌）' },
...
export const asagao: Character = {
  ...
  chapters: ['朝颜', '行幸', '初音'],
  relations: [
    { targetId: 'genji', type: 'love', label: '婉拒·思慕未成' },
  ],
};
