...
export const touNoChujo: Character = {
  ...
  relations: [
    { targetId: 'aoi', type: 'blood', label: '兄妹' },
    { targetId: 'yugao', type: 'love', label: '旧情人（遗弃）' },
    { targetId: 'tamakazura', type: 'blood', label: '父女' },
    { targetId: 'kashiwagi', type: 'blood', label: '父子' },
...
export const yugiri: Character = {
  ...
  relations: [
    ...
    { targetId: 'aoi', type: 'blood', label: '母子' },
...
export const tamakazura: Character = {
  ...
  relations: [
    { targetId: 'yugao', type: 'blood', label: '母女' },
    { targetId: 'tou-no-chujo', type: 'blood', label: '父女' },
...
export const kashiwagi: Character = {
  ...
  relations: [
    { targetId: 'tou-no-chujo', type: 'blood', label: '父子' },
    { targetId: 'onna-sannomiya', type: 'love', label: '私通（薰之生父）' },
    { targetId: 'kaoru', type: 'blood', label: '生父（秘密）' },
